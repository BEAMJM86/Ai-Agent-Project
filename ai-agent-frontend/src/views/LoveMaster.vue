...
useHead({
  ...
  meta: [
    {
      name: 'description',
      content: 'AI健康大师是BEAM: AI超级智能体应用平台的专业健康顾问，帮你解答各种健康问题，提供健康生活建议'
    },
    {
      name: 'keywords',
      content: 'AI健康大师,情感顾问,健康咨询,AI聊天,健康问题,BEAM,AI智能体'
    }
  ]
})
...
onMounted(() => {
  ...
  // 添加欢迎消息
  addMessage('欢迎来到 AI 健康大师！有任何健康相关的问题都可以随时跟我说，我会尽力给你实用的建议和贴心的帮助。', false)
})
